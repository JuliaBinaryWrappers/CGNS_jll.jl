# Autogenerated wrapper script for CGNS_jll for aarch64-unknown-freebsd-mpi+mpitrampoline
...
function __init__()
    JLLWrappers.@generate_init_header(HDF5_jll, MPItrampoline_jll, MPIPreferences)
